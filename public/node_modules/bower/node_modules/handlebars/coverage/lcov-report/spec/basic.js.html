...
<span class="cstat-no"
      title="statement not covered">    shouldCompileTo("\\{{foo}}", { foo: "food" }, "{{foo}}");</span>
<span class="cstat-no" title="statement not covered">    shouldCompileTo("content \\{{foo}}", { foo: "food" }, "content {{foo}}");</span>
<span class="cstat-no"
      title="statement not covered">    shouldCompileTo("\\\\{{foo}}", { foo: "food" }, "\\food");</span>
...
<span class="cstat-no"
      title="statement not covered">    shouldCompileTo("{{! Goodbye}}Goodbye\n{{cruel}}\n{{world}}!",</span>
...
<span class="cstat-no" title="statement not covered">    var hash = {awesome: <span class="fstat-no"
                                                                                    title="function not covered">function() {</span> <span
    class="cstat-no"
    title="statement not covered">return new Handlebars.SafeString("&amp;\"\\&lt;&gt;"); </span>}};</span>
<span class="cstat-no"
      title="statement not covered">    shouldCompileTo("{{awesome}}", hash, '&amp;\"\\&lt;&gt;',</span>
        "functions returning safestrings aren't escaped");
  });
&nbsp;
  it("functions", <span class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{awesome}}", {awesome: <span class="fstat-no"
                                                                                                        title="function not covered">function() {</span> <span
...
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{awesome}}", {awesome: <span class="fstat-no"
                                                                                                        title="function not covered">function() {</span> <span
    class="cstat-no"
    title="statement not covered">return this.more; </span>}, more:  "More awesome"}, "More awesome",</span>
...
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{awesome frank}}",</span>
        {awesome: <span class="fstat-no" title="function not covered">function(context) {</span> <span class="cstat-no"
                                                                                                       title="statement not covered">return context; </span>},
          frank: "Frank"},
...
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{bar.awesome frank}}",</span>
        {bar: {awesome: <span class="fstat-no" title="function not covered">function(context) {</span> <span
...
<span class="cstat-no"
      title="statement not covered">    shouldCompileTo("{{#with frank}}{{../awesome .}}{{/with}}",</span>
        {awesome: <span class="fstat-no" title="function not covered">function(context) {</span> <span class="cstat-no"
                                                                                                       title="statement not covered">return context; </span>},
          frank: "Frank"},
        "Frank", "functions are called with context arguments");
...
&nbsp;
  it("depthed block functions with context argument", <span class="fstat-no"
...
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{#awesome}}inner{{/awesome}}",</span>
        {awesome: <span class="fstat-no" title="function not covered">function(options) {</span> <span class="cstat-no"
                                                                                                       title="statement not covered">return options.fn(this); </span>}},
        "inner", "block functions are called with options");
  });
  it("pathed block functions without context argument", <span class="fstat-no"
                                                              title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{#foo.awesome}}inner{{/foo.awesome}}",</span>
        {foo: {awesome: <span class="fstat-no" title="function not covered">function(options) {</span> <span
...
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{#with value}}{{#../awesome}}inner{{/../awesome}}{{/with}}",</span>
        {value: true, awesome: <span class="fstat-no" title="function not covered">function(options) {</span> <span
                class="cstat-no" title="statement not covered">return this; </span>}},
        "inner", "block functions are called with options");
  });
&nbsp;
...
<span class="cstat-no"
      title="statement not covered">    shouldCompileTo("{{person/name}}", {person: {name: null}}, "");</span>
...
<span class="cstat-no"
      title="statement not covered">    var hash = {goodbyes: ["goodbye", "Goodbye", "GOODBYE"]};</span>
...
<span class="cstat-no" title="statement not covered">    var helpers = {foo: <span class="fstat-no"
...
<span class="cstat-no"
      title="statement not covered">    var string = "{{#hellos}}{{foo text/this/foo}}{{/hellos}}";</span>
<span class="cstat-no" title="statement not covered">    shouldThrow(<span class="fstat-no"
                                                                           title="function not covered">function() {</span></span>
<span class="cstat-no" title="statement not covered">      CompilerContext.compile(string);</span>
    }, Error);
