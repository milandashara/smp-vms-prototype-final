...
<pre><table class="coverage">
  ...
  it("arguments to helpers can be retrieved from options hash in string form", <span class="fstat-no"
...
<span class="cstat-no"
      title="statement not covered">        return "HELP ME MY BOSS " + passiveVoice + ' ' + noun;</span>
      }
    };
&nbsp;
...
&nbsp;
  it("when inside a block in String mode, .. passes the appropriate context in the options hash", <span class="fstat-no"
                                                                                                        title="function not covered">function() {</span>
...
&nbsp;
  it("information about the types is passed along", <span class="fstat-no"
                                                          title="function not covered">function() {</span>
...
<span class="cstat-no"
      title="statement not covered">        equal(trueBool, true, "raw booleans are passed through");</span>
<span class="cstat-no"
      title="statement not covered">        equal(falseBool, false, "raw booleans are passed through");</span>
