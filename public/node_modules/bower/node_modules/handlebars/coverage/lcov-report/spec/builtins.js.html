...
<div class="header low">
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">spec/</a> &#187; builtins.js
    </div>
</div>
<div class="body">
...
<span class="cstat-no"
      title="statement not covered">      shouldCompileTo(string, {world: "world"}, "cruel world!",</span>
...
<span class="cstat-no" title="statement not covered">      var string   = "{{#if goodbye}}GOODBYE {{/if}}cruel {{world}}!";</span>
<span class="cstat-no" title="statement not covered">      shouldCompileTo(string, {goodbye: <span class="fstat-no"
...
<span class="cstat-no" title="statement not covered">      shouldCompileTo(string, {goodbye: <span class="fstat-no"
                                                                                                   title="function not covered">function() {<span
    class="cstat-no"
    title="statement not covered"></span>return this.foo;}</span>, world: "world"}, "cruel world!",</span>
...
<span class="cstat-no"
      title="statement not covered">      var string = "{{#with person}}{{first}} {{last}}{{/with}}";</span>
...
<span class="cstat-no"
      title="statement not covered">      var string = "{{#with person}}{{first}} {{last}}{{/with}}";</span>
<span class="cstat-no" title="statement not covered">      shouldCompileTo(string, {person: <span class="fstat-no"
                                                                                                  title="function not covered">function() {</span> <span
    class="cstat-no"
    title="statement not covered">return {first: "Alan", last: "Johnson"};}</span>}, "Alan Johnson");</span>
    });
...
<span class="cstat-no" title="statement not covered">      var string = "{{#each goodbyes}}{{text}}! {{/each}}cruel {{world}}!";</span>
<span class="cstat-no" title="statement not covered">      var hash   = {goodbyes: <span class="fstat-no"
                                                                                         title="function not covered">function () {</span> <span
    class="cstat-no"
    title="statement not covered">return [{text: "goodbye"}, {text: "Goodbye"}, {text: "GOODBYE"}];}</span>, world: "world"};</span>
<span class="cstat-no" title="statement not covered">      shouldCompileTo(string, hash, "goodbye! Goodbye! GOODBYE! cruel world!",</span>
...
<span class="cstat-no" title="statement not covered">    handlebarsEnv.log = <span class="fstat-no"
                                                                                   title="function not covered">function(level, arg){</span></span>
...
&nbsp;
<span class="cstat-no"
      title="statement not covered">    shouldCompileTo(string, hash, "", "log should not display");</span>
