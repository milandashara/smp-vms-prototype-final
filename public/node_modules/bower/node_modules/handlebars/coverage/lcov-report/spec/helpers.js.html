...
<div class="header low">
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">spec/</a> &#187; helpers.js
    </div>
</div>
<div class="body">
...
<span class="cstat-no"
      title="statement not covered">    var string = "{{#goodbyes}}{{{link ../prefix}}}{{/goodbyes}}";</span>
<span class="cstat-no" title="statement not covered">    var hash = {prefix: "/root", goodbyes: [{text: "Goodbye", url: "goodbye"}]};</span>
<span class="cstat-no" title="statement not covered">    var helpers = {link: <span class="fstat-no"
                                                                                    title="function not covered">function(prefix) {</span></span>
...
<span class="cstat-no" title="statement not covered">    var helpers = { raw: <span class="fstat-no"
...
<span class="cstat-no"
      title="statement not covered">    var string   = "{{{{raw 1 2 3}}}} {{test}} {{{{/raw}}}}";</span>
<span class="cstat-no" title="statement not covered">    var hash = { test: "hello" };</span>
<span class="cstat-no" title="statement not covered">    var helpers = { raw: <span class="fstat-no"
                                                                                    title="function not covered">function(a, b, c, options) {</span></span>
<span class="cstat-no" title="statement not covered">        return options.fn() + a + b + c;</span>
    } };
<span class="cstat-no"
      title="statement not covered">    shouldCompileTo(string, [hash, helpers], " {{test}} 123",</span>
                    "raw block helper gets raw content");
  });

  it("helper block with complex lookup expression", <span class="fstat-no"
...
<span class="cstat-no" title="statement not covered">    var helpers = {goodbyes: <span class="fstat-no"
                                                                                        title="function not covered">function(options) {</span></span>
...
&nbsp;
  it("helper with complex lookup and nested template", <span class="fstat-no"
                                                             title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var string = "{{#goodbyes}}{{#link ../prefix}}{{text}}{{/link}}{{/goodbyes}}";</span>
<span class="cstat-no" title="statement not covered">    var hash = {prefix: '/root', goodbyes: [{text: "Goodbye", url: "goodbye"}]};</span>
<span class="cstat-no" title="statement not covered">    var helpers = {link: <span class="fstat-no"
                                                                                    title="function not covered">function (prefix, options) {</span></span>
...
&nbsp;
  it("helper with complex lookup and nested template in VM+Compiler", <span class="fstat-no"
                                                                            title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var string = "{{#goodbyes}}{{#link ../prefix}}{{text}}{{/link}}{{/goodbyes}}";</span>
<span class="cstat-no" title="statement not covered">    var hash = {prefix: '/root', goodbyes: [{text: "Goodbye", url: "goodbye"}]};</span>
<span class="cstat-no" title="statement not covered">    var helpers = {link: <span class="fstat-no"
...
&nbsp;
<span class="cstat-no"
      title="statement not covered">    var result = template({world: "world"}, { helpers: {goodbyes: <span
    class="fstat-no" title="function not covered">function(options) {</span> <span class="cstat-no"
                                                                                   title="statement not covered">return options.fn({text: "GOODBYE"}); </span>}}});</span>
...
<span class="cstat-no"
      title="statement not covered">    var string   = "{{#form}}&lt;p&gt;{{name}}&lt;/p&gt;{{/form}}";</span>
<span class="cstat-no" title="statement not covered">    var template = CompilerContext.compile(string);</span>
&nbsp;
<span class="cstat-no" title="statement not covered">    var result = template({name: "Yehuda"}, {helpers: {form: <span
    class="fstat-no" title="function not covered">function(options) {</span> <span class="cstat-no"
                                                                                   title="statement not covered">return "&lt;form&gt;" + options.fn(this) + "&lt;/form&gt;"; </span>} }});</span>
...
<span class="cstat-no" title="statement not covered">    var result = template({yehuda: {name: "Yehuda"}}, { helpers: {form: <span
    class="fstat-no" title="function not covered">function(context, options) {</span> <span class="cstat-no"
                                                                                            title="statement not covered">return "&lt;form&gt;" + options.fn(context) + "&lt;/form&gt;"; </span>}}});</span>
<span class="cstat-no" title="statement not covered">    equal(result, "&lt;form&gt;&lt;p&gt;Yehuda&lt;/p&gt;&lt;/form&gt;", "Context variable resolved");</span>
  });
&nbsp;
  it("block helper passing a complex path context", <span class="fstat-no"
                                                          title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">    var result = template({</span>
      ...
      helpers: {
        link: <span class="fstat-no" title="function not covered">function(options) {</span> <span class="cstat-no"
                                                                                                   title="statement not covered">return "&lt;a href='" + this.name + "'&gt;" + options.fn(this) + "&lt;/a&gt;"; </span>},
...
<span class="cstat-no"
      title="statement not covered">        return "&lt;p&gt;" + options.inverse(this) + "&lt;/p&gt;";</span>
      }
    };
&nbsp;
...
<span class="cstat-no"
      title="statement not covered">    shouldCompileTo('{{./helper 1}}', [hash, helpers], 'winning');</span>
...
<span class="cstat-no" title="statement not covered">      shouldCompileTo("Goodbye {{cruel}} {{world}}!", [{cruel: "cruel"}, {world: <span
    class="fstat-no" title="function not covered">function() {</span> <span class="cstat-no"
                                                                            title="statement not covered">return "world"; </span>}}], "Goodbye cruel world!",</span>
...
<span class="cstat-no" title="statement not covered">      shouldCompileTo("Goodbye {{#iter}}{{cruel}} {{world}}{{/iter}}!", [{iter: [{cruel: "cruel"}]}, {world: <span
    class="fstat-no" title="function not covered">function() {</span> <span class="cstat-no"
                                                                            title="statement not covered">return "world"; </span>}}],</span>
...
<span class="cstat-no" title="statement not covered">      shouldCompileTo("{{{lookup}}}", [{lookup: 'Explicit'}, {lookup: <span
    class="fstat-no" title="function not covered">function() {</span> <span class="cstat-no"
                                                                            title="statement not covered">return 'helpers'; </span>}}], "helpers",</span>
...
<span class="cstat-no" title="statement not covered">      shouldCompileTo("{{#outer}}{{#inner}}{{helper}}{{/inner}}{{/outer}}",</span>
                    [{'outer': {'inner': {'unused':[]}}},  {'helper': <span class="fstat-no"
...
<span class="cstat-no" title="statement not covered">      handlebarsEnv.registerHelper('test_helper', <span
    class="fstat-no" title="function not covered">function() {</span> <span class="cstat-no"
                                                                            title="statement not covered">return 'found it!'; </span>});</span>
&nbsp;
<span class="cstat-no" title="statement not covered">      shouldCompileTo(</span>
        "{{test_helper}} {{#if cruel}}Goodbye {{cruel}} {{world}}!{{/if}}", [
          {cruel: "cruel"},
          {world: <span class="fstat-no" title="function not covered">function() {</span> <span class="cstat-no"
                                                                                                title="statement not covered">return "world!"; </span>}}
        ],
...
<span class="cstat-no" title="statement not covered">    handlebarsEnv.registerHelper({</span>
      ...
      world: <span class="fstat-no" title="function not covered">function() {</span> <span class="cstat-no"
                                                                                           title="statement not covered">return "world!"; </span>},
      test_helper: <span class="fstat-no" title="function not covered">function() {</span> <span class="cstat-no"
                                                                                                 title="statement not covered">return 'found it!'; </span>}
    });
&nbsp;
<span class="cstat-no" title="statement not covered">    shouldCompileTo(</span>
      "{{test_helper}} {{#if cruel}}Goodbye {{cruel}} {{world}}!{{/if}}",
...
<span class="cstat-no" title="statement not covered">    var hash     = {};</span>
<span class="cstat-no" title="statement not covered">    var helpers  = {hello: <span class="fstat-no"
                                                                                      title="function not covered">function(times, times2) {</span></span>
<span class="cstat-no" title="statement not covered">      if(typeof times !== 'number') { <span class="cstat-no"
                                                                                                 title="statement not covered">times = "NaN"; </span>}</span>
<span class="cstat-no" title="statement not covered">      if(typeof times2 !== 'number') { <span class="cstat-no"
                                                                                                  title="statement not covered">times2 = "NaN"; </span>}</span>
...
<span class="cstat-no" title="statement not covered">    var hash     = {};</span>
<span class="cstat-no" title="statement not covered">    var helpers  = {hello: <span class="fstat-no"
                                                                                      title="function not covered">function(times) {</span></span>
<span class="cstat-no" title="statement not covered">      if(typeof times !== 'number') { <span class="cstat-no"
                                                                                                 title="statement not covered">times = "NaN"; </span>}</span>
...
<span class="cstat-no"
      title="statement not covered">      var string   = 'Message: {{hello "world" 12 true false}}';</span>
<span class="cstat-no" title="statement not covered">      var hash     = {};</span>
<span class="cstat-no" title="statement not covered">      var helpers  = {hello: <span class="fstat-no"
                                                                                        title="function not covered">function(param, times, bool1, bool2) {</span></span>
<span class="cstat-no" title="statement not covered">        if(typeof times !== 'number') { <span class="cstat-no"
                                                                                                   title="statement not covered">times = "NaN"; </span>}</span>
<span class="cstat-no" title="statement not covered">        if(typeof bool1 !== 'boolean') { <span class="cstat-no"
                                                                                                    title="statement not covered">bool1 = "NaB"; </span>}</span>
<span class="cstat-no" title="statement not covered">        if(typeof bool2 !== 'boolean') { <span class="cstat-no"
                                                                                                    title="statement not covered">bool2 = "NaB"; </span>}</span>
...
&nbsp;
    it("using a quote in the middle of a parameter raises an error", <span class="fstat-no"
                                                                           title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">      var hash     = {};</span>
<span class="cstat-no" title="statement not covered">      var helpers = {hello: <span class="fstat-no"
                                                                                       title="function not covered">function(param) {</span> <span
...
<span class="cstat-no" title="statement not covered">      var helpers = {goodbye: <span class="fstat-no"
                                                                                         title="function not covered">function(cruel, world) {</span> <span
...
<span class="cstat-no" title="statement not covered">      var hash     = {cruel: "cruel", world: "world"};</span>
<span class="cstat-no" title="statement not covered">      var helpers = {goodbye: <span class="fstat-no"
                                                                                         title="function not covered">function(cruel, world, options) {</span></span>
...
<span class="cstat-no" title="statement not covered">      var result = template(context, {helpers: helpers});</span>
<span class="cstat-no"
      title="statement not covered">      equals(result, "GOODBYE CRUEL WORLD", "Helper output hash");</span>
&nbsp;
...
&nbsp;
    it("block helpers can take an optional hash with single quoted stings", <span class="fstat-no"
                                                                                  title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var template = CompilerContext.compile("{{#goodbye cruel='CRUEL' times=12}}world{{/goodbye}}");</span>
&nbsp;
<span class="cstat-no" title="statement not covered">      var helpers = {</span>
...
<span class="cstat-no" title="statement not covered">      var result = template({}, {helpers: {hello: <span
    class="fstat-no" title="function not covered">function() {</span> <span class="cstat-no"
                                                                            title="statement not covered">return "foo"; </span>}}});</span>
<span class="cstat-no" title="statement not covered">      equal(result, "foo", "'foo' should === '" + result);</span>
    });
&nbsp;
    it("Unknown helper in knownHelpers only mode should be passed as undefined", <span class="fstat-no"
                                                                                       title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">      var result = template({}, {helpers: {'typeof': <span
    class="fstat-no" title="function not covered">function(arg) {</span> <span class="cstat-no"
                                                                               title="statement not covered">return typeof arg; </span>}, hello: <span
    class="fstat-no" title="function not covered">function() {</span> <span class="cstat-no"
                                                                            title="statement not covered">return "foo"; </span>}}});</span>
...
<span class="cstat-no" title="statement not covered">      equal(result, "bar", "'bar' should === '" + result);</span>
    ...
    it("Field lookup works in knownHelpers only mode", <span class="fstat-no"
                                                             title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">      equal(result, "bar", "'bar' should === '" + result);</span>
    ...
    it("Invert blocks work in knownHelpers only mode", <span class="fstat-no"
                                                             title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var template = CompilerContext.compile("{{^foo}}bar{{/foo}}", {knownHelpersOnly: true});</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered">      equal(result, "bar", "'bar' should === '" + result);</span>
    ...
    it("Functions are bound to the context in knownHelpers only mode", <span class="fstat-no"
                                                                             title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var template = CompilerContext.compile("{{foo}}", {knownHelpersOnly: true});</span>
<span class="cstat-no" title="statement not covered">      var result = template({foo: <span class="fstat-no"
                                                                                             title="function not covered">function() {</span> <span
    class="cstat-no" title="statement not covered">return this.bar; </span>}, bar: 'bar'});</span>
<span class="cstat-no" title="statement not covered">      equal(result, "bar", "'bar' should === '" + result);</span>
    });
    it("Unknown helper call in knownHelpers only mode should throw", <span class="fstat-no"
                                                                           title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      shouldThrow(<span class="fstat-no"
                                                                             title="function not covered">function() {</span></span>
...
&nbsp;
  describe("blockHelperMissing", function() {
    it("lambdas are resolved by blockHelperMissing, not handlebars proper", <span class="fstat-no"
                                                                                  title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var string = "{{#truthy}}yep{{/truthy}}";</span>
<span class="cstat-no" title="statement not covered">      var data = { truthy: <span class="fstat-no"
                                                                                      title="function not covered">function() {</span> <span
...
<span class="cstat-no" title="statement not covered">      shouldCompileTo(string, data, "yep");</span>
    ...
    it("lambdas resolved by blockHelperMissing are bound to the context", <span class="fstat-no"
                                                                                title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var string = "{{#truthy}}yep{{/truthy}}";</span>
<span class="cstat-no" title="statement not covered">      var boundData = { truthy: <span class="fstat-no"
                                                                                           title="function not covered">function() {</span> <span
    class="cstat-no" title="statement not covered">return this.truthiness(); </span>}, truthiness: <span
    class="fstat-no" title="function not covered">function() {</span> <span class="cstat-no"
                                                                            title="statement not covered">return false; </span>} };</span>
...
<span class="cstat-no"
      title="statement not covered">        return 'missing: ' + arguments[arguments.length-1].name;</span>
      },
...
&nbsp;
    it('should include in ambiguous mustache calls', <span class="fstat-no"
                                                           title="function not covered">function() {</span>
...
&nbsp;
<span class="cstat-no"
      title="statement not covered">      equal(template({}, {helpers: helpers}), 'ran: helper');</span>
    });
&nbsp;
...
&nbsp;
    it('should include full id if a hash is passed', <span class="fstat-no"
                                                           title="function not covered">function() {</span>
...
&nbsp;
  describe('name conflicts', function() {
    it("helpers take precedence over same-named context properties", <span class="fstat-no"
                                                                           title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">      var result = template(context, {helpers: helpers});</span>
<span class="cstat-no"
      title="statement not covered">      equals(result, "GOODBYE cruel WORLD", "Helper executed");</span>
    });
&nbsp;
    it("helpers take precedence over same-named context properties$", <span class="fstat-no"
                                                                            title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">      var helpers = {</span>
        goodbye: <span class="fstat-no" title="function not covered">function(options) {</span>
<span class="cstat-no"
      title="statement not covered">          return this.goodbye.toUpperCase() + options.fn(this);</span>
        },
&nbsp;
        cruel: <span class="fstat-no" title="function not covered">function(world) {</span>
<span class="cstat-no" title="statement not covered">          return "cruel " + world.toUpperCase();</span>
...
&nbsp;
    it("Scoped names take precedence over helpers", <span class="fstat-no"
                                                          title="function not covered">function() {</span>
