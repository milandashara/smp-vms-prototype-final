...
<span class="cstat-no"
      title="statement not covered">    var string = "{{#books}}{{title}}{{author.name}}{{/books}}";</span>
...
<span class="cstat-no"
      title="statement not covered">    var string = "{{^set}}not set{{/set}} :: {{#set}}set{{/set}}";</span>
&nbsp;
...
&nbsp;
<span class="cstat-no"
      title="statement not covered">    shouldCompileTo(string, data, "1, 2", "it works as expected");</span>
  });
&nbsp;
  it("bug reported by @fat where lambdas weren't being properly resolved", <span class="fstat-no"
...
<span class="cstat-no" title="statement not covered">    var helpers = {</span>
      blk: <span class="fstat-no" title="function not covered">function(block) {</span> <span class="cstat-no"
                                                                                              title="statement not covered">return block.fn(''); </span>},
      inverse: <span class="fstat-no" title="function not covered">function(block) {</span> <span class="cstat-no"
                                                                                                  title="statement not covered">return block.inverse(''); </span>}
    };
&nbsp;
...
&nbsp;
  it("GH-676: Using array in escaping mustache fails", <span class="fstat-no"
                                                             title="function not covered">function() {</span>
...
&nbsp;
  if (Handlebars.AST) {
    it("can pass through an already-compiled AST via compile/precompile", <span class="fstat-no"
                                                                                title="function not covered">function() {</span>
