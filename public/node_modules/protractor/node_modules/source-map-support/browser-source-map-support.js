...
(this.define || function (J, N) {
    ...
    (function h(r, m, e) {
        ...
        for (var u = "function" == typeof require && require, z = 0; z < e.length; z++)p(e[z]);
        return p
    })({
        1: [function (h,
                      r, m) {
        ...
        3: [function (h, r, m) {
            function e(f, n, w) {
                if (!(this instanceof e))return new e(f, n, w);
                var a = typeof f;
                if ("base64" === n && "string" === a)for (f = f.trim ? f.trim() : f.replace(/^\s+|\s+$/g, ""); 0 !== f.length % 4;)f += "=";
                var b;
                if ("number" === a)b = v(f); else if ("string" === a)b = e.byteLength(f, n); else if ("object" === a)b = v(f.length); else throw Error("First argument needs to be a number, array or string.");
                var c;
                ...
                if (e._useTypedArrays && "number" === typeof f.byteLength)c._set(f); else {
                    var d = f;
                    if (x(d) || e.isBuffer(d) || d && "object" === typeof d && "number" === typeof d.length)for (n = 0; n < b; n++)e.isBuffer(f) ? c[n] = f.readUInt8(n) : c[n] = f[n]; else if ("string" === a)c.write(f, 0, n); else if ("number" === a && !e._useTypedArrays && !w)for (n = 0; n < b; n++)c[n] = 0
                }
                return c
            }
            ...
            function p(f, n, w) {
                var a = "";
                for (w = Math.min(f.length, w); n < w; n++)a += String.fromCharCode(f[n]);
                return a
            }

            function u(f, n, w, a) {
                a || (q("boolean" === typeof w,
                    "missing or invalid endian"), q(void 0 !== n && null !== n, "missing offset"), q(n + 1 < f.length, "Trying to read beyond buffer length"));
                a = f.length;
                if (!(n >= a))return w ? (w = f[n], n + 1 < a && (w |= f[n + 1] << 8)) : (w = f[n] << 8, n + 1 < a && (w |= f[n + 1])), w
            }
            ...
            function g(f, n, a, b) {
                ...
                if (!(n >= f.length))return f = u(f, n, a, !0), f & 32768 ? -1 * (65535 - f + 1) : f
            }
            ...
            function d(f, n, a, b) {
                ...
                if (!(n >=
                    f.length))return f = z(f, n, a, !0), f & 2147483648 ? -1 * (4294967295 - f + 1) : f
            }
            ...
            function c(f, n, a, b, c) {
                ...
                a && null !== a, "missing offset"), q(a + 1 < f.length, "trying to write beyond buffer length"), K(n, 65535));
                var d = f.length;
            ...
            function A(f, n, a, b, c) {
                c || (q(void 0 !== n && null !== n, "missing value"), q("boolean" === typeof b, "missing or invalid endian"),
                    q(void 0 !== a && null !== a, "missing offset"), q(a + 7 < f.length, "Trying to write beyond buffer length"), M(n, 1.7976931348623157E308, -1.7976931348623157E308));
            ...
            e.prototype.toString = function (f, a, b) {
                ...
                switch (f) {
                    ...
                    case "utf-8":
                        var c = a;
                        a = f = "";
                        for (b = Math.min(this.length, b); c < b; c++)127 >= this[c] ? (f += F(a) + String.fromCharCode(this[c]), a = "") : a += "%" + this[c].toString(16);
                        b = f + F(a);
                        break;
                    case "ascii":
                        b = p(this, a, b);
            ...
            e.prototype.inspect = function () {
                for (var a = [], b = this.length, c = 0; c < b; c++)if (a[c] = G(this[c]), c === m.INSPECT_MAX_BYTES) {
                    a[c + 1] = "...";
                    break
                }
        ...
        5: [function (h, r, m) {
            m.read = function (e, p, u, h, g) {
                ...
                if (0 === u)u = 1 - l; else {
                    if (u === k)return d ? NaN : Infinity * (b ? -1 : 1);
                    d += Math.pow(2, h);
                    u -= l
                }
            ...
            m.write = function (e, p, u, h, g, d) {
                ...
                d = h ? 0 : d - 1;
                var y = h ? 1 : -1, B = 0 > p || 0 === p && 0 > 1 / p ? 1 : 0;
                p = Math.abs(p);
        ...
        13: [function (h, r, m) {
            ...
            e(function (e, h, m) {
                ...
                g.prototype._parseMappings = function (a, b) {
                    for (var e = 1, g = 0, l = 0, h = 0, k = 0, x = 0, m = /^[,;]/, s = a, p; 0 < s.length;)if (";" === s.charAt(0))e++, s = s.slice(1), g = 0; else if ("," === s.charAt(0))s = s.slice(1); else {
                        p = {};
                        p.generatedLine = e;
                        s = c.decode(s);
                        ...
                        if (0 < s.length && !m.test(s.charAt(0))) {
                            ...
                            k += s.value;
                            s = s.rest;
                            if (0 === s.length || m.test(s.charAt(0)))throw Error("Found a source, but no line and column");
                            s = c.decode(s);
                            p.originalLine = l + s.value;
                            l = p.originalLine;
                            p.originalLine += 1;
                            s = s.rest;
                            if (0 === s.length || m.test(s.charAt(0)))throw Error("Found a source and line, but no column");
                            s = c.decode(s);
        ...
        14: [function (h, r, m) {
            ...
            e(function (e, h, m) {
                ...
                g.prototype._serializeMappings = function () {
                    var c = 0, a = 1, b = 0, e = 0, g = 0, l = 0, h = "", v;
                    this._mappings.sort(k.compareByGeneratedPositions);
                    for (var x = 0, p = this._mappings.length; x < p; x++) {
                        v = this._mappings[x];
                        if (v.generatedLine !== a)for (c =
                                                           0; v.generatedLine !== a;)h += ";", a++; else if (0 < x) {
                            if (!k.compareByGeneratedPositions(v, this._mappings[x - 1]))continue;
                            h += ","
                        }
        ...
        15: [function (h, r, m) {
            ...
            e(function (e, h, m) {
                ...
                g.prototype.toStringWithSourceMap = function (e) {
                    var c =
                        "", a = 1, b = 0, g = new d(e), h = !1, k = null, p = null, v = null, m = null;
                    this.walk(function (d, e) {
                        ...
                        null !== e.source && null !== e.line && null !== e.column ? (k === e.source && p === e.line && v === e.column && m === e.name || g.addMapping({
                            ...
                            name: e.name
                        }), k = e.source, p = e.line, v = e.column, m = e.name, h = !0) : h && (g.addMapping({
                            generated: {
                                line: a,
                                column: b
                            }
                ...
                r.exports = function (m, r) {
                    function g(a, b) {
                        ...
                        if (a && "." === a.charAt(0) && b) {
                            ...
                            for (e = 0; d[e]; e += 1)if (g = d[e], "." === g)d.splice(e, 1), e -= 1; else if (".." === g)if (1 !== e || ".." !== d[2] && ".." !== d[0])0 < e && (d.splice(e - 1, 2), e -= 2); else break;
                            a = c.join("/")
                        }
                        return a
                    }
                    ...
                    function l(a, c, d) {
                        var e, g, h;
                        if (a)g = b[a] = {}, h = {id: a, uri: p, exports: g}, e = A(r, g, h, a); else {
                            if (y)throw Error("amdefine with no module ID cannot be called more than once per file.");
                            y = !0;
                            g = m.exports;
                            h = m;
                            e = A(r, g, h, m.id)
                    ...
                    var a = {}, b = {}, y = !1, B = h("path"), A, C;
                    A = function (a, b, c, d) {
                        function h(g, k) {
                            if ("string" === typeof g)return C(a, b, c, g, d);
                            g = g.map(function (e) {
                                return C(a, b, c, e, d)
                            });
                            e.nextTick(function () {
        ...
        18: [function (h, r, m) {
            (function (e, p) {
                ...
                function g(a, b) {
                    if (!a)return b;
                    var c = v.dirname(a), d = /^\w+:\/\/[^\/]*/.exec(c), d = d ? d[0] : "";
                ...
                function d(a) {
                    ...
                    if (!b)return null;
                    "data:application/json;base64," == b.slice(0, 29).toLowerCase() ? (a =
                        (new p(b.slice(29), "base64")).toString(), b = null) : (b = g(a, b), a = z(b, "utf8"));
                ...
                function c() {
                    ...
                    if (this.isToplevel() ||
                        e)e ? a += "new " + (c || "<anonymous>") : c ? a += c : (a += b, d = !1); else {
                ...
                var C = h("source-map").SourceMapConsumer, v = h("path"), x = h("fs"), G = !1, s = !1, D = {}, E = {};
                m.wrapCallSite = b;
                m.getErrorSource = B;
