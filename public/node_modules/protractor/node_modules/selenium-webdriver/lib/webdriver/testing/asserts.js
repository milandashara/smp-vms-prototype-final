 ...
 */
webdriver.testing.Assertion.prototype.greaterThan = function (value, opt_message) {
    return this.apply(
 ...
 * @return {webdriver.promise.Promise} The assertion result.
 */
webdriver.testing.Assertion.prototype.greaterThanEqualTo = function (value, opt_message) {
    return this.apply(
 ...
 * @return {webdriver.promise.Promise} The assertion result.
 */
webdriver.testing.Assertion.prototype.lessThanEqualTo = function (value, opt_message) {
    return this.apply(
 ...
 * @return {webdriver.promise.Promise} The assertion result.
 */
webdriver.testing.Assertion.prototype.closeTo = function (value, range, opt_message) {
    return this.apply(
 ...
 * @return {webdriver.promise.Promise} The assertion result.
 */
webdriver.testing.Assertion.prototype.isNullOrUndefined = function (opt_message) {
    return this.apply(
 ...
 * @return {webdriver.promise.Promise} The assertion result.
 */
webdriver.testing.Assertion.prototype.endsWith = function (suffix, opt_message) {
    return this.apply(
 ...
 * @return {webdriver.promise.Promise} The assertion result.
 */
webdriver.testing.Assertion.prototype.startsWith = function (prefix, opt_message) {
    return this.apply(
...
/** @override */
webdriver.testing.NegatedAssertion.prototype.apply = function (matcher, opt_message) {
 ...
 */
webdriver.testing.asserts.assertThat = function (failureMessageOrActualValue, actualValueOrMatcher, opt_matcher) {
