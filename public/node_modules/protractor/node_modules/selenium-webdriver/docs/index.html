<!DOCTYPE html>
<meta charset="UTF-8">
<meta http-equiv="Content-Language" content="en"/><title>Index</title>
...
<pre><code>var webdriver = require('selenium-webdriver');
    ...
    driver.quit();
        ...
        <p>API documentation is included in the docs module. The API documentation for the
            current release are also available online from the <a
                    href="http://selenium.googlecode.com/git/docs/api/javascript/index.html" title="API docs">Selenium
                project</a>. A full user guide is available on the
            <a href="http://code.google.com/p/selenium/wiki/WebDriverJs" title="User guide">Selenium project wiki</a>.
        </p>

        <h2>Issues</h2>

        <p>Please report any issues using the <a href="https://code.google.com/p/selenium/issues/list">Selenium issue
            tracker</a>.</p>
